  ...
  config = {
    ...
    systemd = {
      services = {
        ...
        # Volumes
        "docker-volume-khoj_khoj_config" = {
          path = [ pkgs.docker ];
          serviceConfig = {
            Type = "oneshot";
            RemainAfterExit = true;
        ...
        "docker-volume-khoj_khoj_models" = {
          path = [ pkgs.docker ];
          serviceConfig = {
            Type = "oneshot";
            RemainAfterExit = true;
        ...
        "docker-volume-khoj_khoj_search" = {
          path = [ pkgs.docker ];
          serviceConfig = {
            Type = "oneshot";
            RemainAfterExit = true;
      ...
      targets."docker-compose-khoj-root" = {
        unitConfig = {
