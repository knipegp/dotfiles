...

{
  ...
  virtualisation.oci-containers.containers."khoj-search" = {
    ...
    log-driver = "journald";
    extraOptions = [ "--network-alias=search" "--network=khoj_default" ];
  };
  ...
  virtualisation.oci-containers.containers."khoj-server" = {
    ...
    log-driver = "journald";
    extraOptions = [ "--network-alias=server" "--network=khoj_default" ];
  };
  ...
  virtualisation.oci-containers.containers."ollama" = {
    ...
    log-driver = "journald";
    extraOptions = [ "--network-alias=ollama" "--network=khoj_default" ];
  };
