...

{
  ...
  networking = {
    hostName = "hana"; # Define your hostname.
  ...
  services = {
    ...
    # Disable KDE power management to prevent sleeping
    # This is handled via config files in the plasma module
  };
  ...
  # Configure SDDM to allow empty passwords for duloc
